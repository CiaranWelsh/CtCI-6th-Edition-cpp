...
/*We just use the code from last problem, created a binary search tree with minimum height. And then we create linked list at each level of the tree.*/
...
int main() {
    ...
    findLevelLinkedLists(level_list, root);
    printLevelLinkedLists(level_list);
}
